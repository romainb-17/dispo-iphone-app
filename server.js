...
// 👉 On fige sur public/ (évite toute vieille build dist/build)
const staticDir = path.join(process.cwd(), 'public');
console.log('👉 Serving ONLY from', staticDir);

// No-cache pour éviter les pages vieilles côté client/CDN
...
app.get('/__debug', (_req,res)=>{
  res.json({
    ...
    env_STATIC_DIR: process.env.STATIC_DIR || null,
...
// Fallback SPA → renvoie public/index.html (jamais d'HTML pour /api/*)
